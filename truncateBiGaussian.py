...
gaussian2 = tpg.genGaussian2DSim_SGSim_aniso(120, 120, 0.5, 0.5, 'spherical', 10, 0.5, 45)
...
faciesMap = tpg.truncBiGaussian23facies(gaussian1, gaussian2, 2, [-0.55555, 0]) # generate facies map with thresholds given as list of values
